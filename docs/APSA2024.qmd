...
## {background-color="white" background-image="https://artofthegreennewdeal.net/wp-content/uploads/2020/08/climate-justice-jobs-mother-1024x645.jpg" background-size="cover" background-opacity=".2"}
...
**Part 1.** Large-scale analysis: *all* 15,000 draft and final rules from 52 agencies 2005-2024 & 40,000,000+ public comments on these draft rules
...
**Part 2.** Medium-scale hand-coded sample of all comments on 200 rules 
...
- radically different meanings across commenters and administrations 
...
- Some meaningful policy changes under all presidents

BUT

- mostly justifying non-targeted policy advanced by historically white national advocacy groups
