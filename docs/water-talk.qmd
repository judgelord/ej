...
## 90% of U.S. law is made by agencies

- Power plants emissions & emissions (EPA)
...
- Organic certification (USDA-AMS)
- Offshore oil and gas drilling (BOEM)
- Pipeline safety (DOT-PHMSA)
- Nuclear power plant safety and evacuation plans (NRC)
- Hydrogen tax credit eligibility (IRS)
- etc.
...
## Example Murcury From Power Plants
...
```{r, fig.show = "hold", out.width = c("20%","20%","20%","20%")}
#| fig-show: hold
...
- E.O. 12898 "Federal Actions to Address Environmental Justice" (1993)
...
From Trump administration's repeal of the Clean Power Plan EJ analysis: 
...
knitr::include_graphics(here::here("figs", "ej-pairs-1.png"))
```
...
## The twenty agencies that most frequently mention EJ in final rules
...
#| out-width: "49%"
#| fig-column: 2
#| fig-cap: "Rates of Change Between Draft and Final Rule"
...
Example: the Obama Nuclear Regulatory Commission  claimed to have received no input on environmental justice commenbts on Emergency Preparedness Regulations [NRC-2008-0122](https://www.regulations.gov/docket/NRC-2008-0122/unified-agenda).
...
- EPA comments to NMFS about effects on low-income fishing communitiesof Atlantic Highly Migratory Species: Atlantic Shark Management Measures; Final Amendment 5b (NOAA-NMFS-2013-0070) 
